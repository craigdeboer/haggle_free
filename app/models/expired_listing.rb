class ExpiredListing < ActiveRecord::Base
	...
	def self.convert(listing, bid_count, highest_bid)
		@expired_listing = ExpiredListing.new(original_listing_id: listing.id, title: listing.title, number_of_bids: bid_count, highest_bid: highest_bid, end_date: listing.end_date, user_id: listing.user_id)
